...
TIPO_DOCS = {'Folha de Ponto': '01', 'FT': '02', 'RG': '30', 'txt': '4', 'txt2': '5'}

ANO = {'2020': '20', '2021': '21', '2022': '22', '2023': '23', '2024': '24', '2025': '25'}
    ...
    for nome_arquivo in os.listdir(pasta_entrada):
        if nome_arquivo.lower().endswith(".pdf"):
            ...
            for img in imagens:
                ...
                texto = pytesseract.image_to_string(img_pre, lang='eng', config=config)
...
botao = tk.Button(janela, text="Selecionar Pastas e Iniciar", command=iniciar_script)
